<template>
    <div class="mayday-checkprize-manage">
        <activityHeader type="perpage" title="超级会员招募季"></activityHeader>
...
<style lang="scss" rel="stylesheet/scss">
    ...
    .mayday-checkprize-manage{
        position: relative;
        height: 101%;
        background: url(/static/images/activity/applet/midyear/check_bg.jpg) top center no-repeat;
        background-size: 100% auto;
        background-color: #5f5ce9;
        .main-content{
            position: relative;
            /*height: 100%;*/
